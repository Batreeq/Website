@extends('layouts.app', ['page' => __('Policy'), 'pageSlug' => 'policy'])
...
<div class="continaer-app-pages container-policy ">
    ...
    <div class="row justify-content-start">
      <button type="submit" class="btn-control-panel btn-erp">لوحة التحكم/صفحات التطبيق/السياسة العامة  </button>
    </div>
    <div class="row justify-content-center">
      <form action="add_policy" method="POST" class="form-input-info">
      @csrf
