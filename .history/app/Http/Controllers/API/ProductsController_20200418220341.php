    ...
    public function myOrders(Request $request)
    {
         ...
         foreach ($orders as $key => $order) {
            ...
            foreach (json_decode($order->order_details) as $key => $product) {
                ...
                // $catrgory = Category::where('id', $product_detail->category_id)->first();
                array_push($products_details, array('quantity' => $product_detail->category_id, 'price' => $product->price, 'total_price' => $product->total_price, 'product_details' => $product, 'catrgory_name' => $catrgory->name));
            }
