      ...
      <div class="col-md-6">
        <div class="row section-action">
            @foreach ($parts as $part)
                ...
                <button onClick="window.open('/offers-screens?offer={{ $part->id }}','_self');" type="submit" href="" class="btn-different btn-chat text-mar">{{ $part->name }} <br><i class="fas fa-edit"></i>
