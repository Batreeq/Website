...
@section('content')
  <div class="container ">
    <div class="row justify-content-start">
      ...
      <button type="submit" onclick="window.open('/edit-different-parts', '_self')" style="margin-right: 2%" class="btn-control-panel btn-erp">إضافة عرض جديد <i class="fas fa-plus"></i> </button>
    </div>
