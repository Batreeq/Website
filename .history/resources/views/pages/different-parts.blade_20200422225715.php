...
@section('content')
  <div class="container ">
    <div class="row justify-content-start">
      ...
      <button type="submit" onclick="window.open('/edit-different-parts', '_self')" style="margin-right: 2%" class="btn-control-panel btn-erp">إضافة عرض جديد <i class="fal fa-plus-circle"></i> </button>
    </div>
        ...
        <div class="row section-action">
            @foreach ($parts as $part)
                ...
                <button type="submit" href="" class="btn-different btn-chat text-mar">
                    ...
                    <a style="color: white;margin: 2%;" href="/offers-screens?offer={{ $part->id }}"><i class="fas fa-edit fa-xs"></i></a>
                    <a style="color: white;margin: 2%;" href="/offers-screens?offer={{ $part->id }}"><i class="fas fa-trash-alt fa-xs"></i></a>
                </button>
            </div>
            @endforeach
            {{-- <div class="col-lg-6">
