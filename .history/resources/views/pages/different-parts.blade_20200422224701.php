        ...
        <div class="row section-action">
            @foreach ($parts as $part)
                ...
                <button type="submit" href="" class="btn-different btn-chat text-mar">
                    ...
                    <br>
                    <a style="color: white;" href="/offers-screens?offer={{ $part->id }}"><i class="fas fa-eye fa-xs"></i></a>
                    <a style="color: white;" href="/offers-screens?offer={{ $part->id }}"><i class="fas fa-edit fa-xs"></i></a>
                    <a style="color: white;" href="/offers-screens?offer={{ $part->id }}"><i class="fas fa-trash-alt fa-xs"></i></a>
                </button>
            </div>
            @endforeach
            {{-- <div class="col-lg-6">
