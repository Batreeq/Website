        ...
        <div class="row ">
          <div class="col-lg-4 ">
            ...
            <div class="input-group">
                <input type="text" name="offer_name" class="form-control"  value="{{ isset($offer->name) ? $offer->name : '' }}">
          ...
          <div class="col-lg-4 ">
            ...
            <div class="input-group{{ $errors->has('product_image') ? ' has-danger' : '' }}">
                <input type="file" name="produc_image" class="form-control {{ $errors->has('product_image') ? ' is-invalid' : '' }}"  value="{{ old('product_image') }}">
            </div>
          </div>
        </div>
