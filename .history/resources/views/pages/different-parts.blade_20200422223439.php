      ...
      <div class="col-md-6">
        <div class="row section-action">
            @foreach ($parts as $part)
                ...
                <button type="submit" href="" class="btn-different btn-chat text-mar"><a style="color: white;" href="/offers-screens?offer={{ $part->id }}">{{ $part->name }}</a> <br><i class="fas fa-edit"></i>
