      ...
      <div class="col-md-6">
        <div class="row section-action">
            @foreach ($parts as $part)
                ...
                <button onClick="window.open('/offers-screens?offer={{ $part->id }}','_self');" type="submit" href="" class="btn-different btn-chat text-mar"><i class="fas fa-edit"></i>
                    <i class="fas fa-trash-alt"></i>{{ $part->name }} </button>
            </div>
            @endforeach
            {{-- <div class="col-lg-6">
