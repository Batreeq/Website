    ...
    <div class="homepage-container container height-all-page py-7 py-lg-8 ">
        ...
        <div class="row justify-content-start mar-0">
            ...
            <div class="col-md-4">
                ...
                <iframe width="100%" style="height: 60vh" id="gmap_canvas" src="https://maps.google.com/maps?q=صيدليات في منطقة {{ $pharmacy->location }}&t=&z=14&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net">
            </div>
        </div>
    </div>
</div>
